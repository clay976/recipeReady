...
module.exports = function setIng (kitchen, req){
	return new Promise (function (fulfill, reject){
		if (kitchen == null){
			...
			kitchen.homepage  = '/loggedIn.html#'+querystring.stringify({'kitchenID':kitchen.kitchenID, 'i1':req.body.ingredient[0], 'i2':req.body.ingredient[1], 'i3':req.body.ingredient[2]})
			fulfill (kitchen)
		}
	})
}